...
export default function Page() {
  ...
  useEffect(() => {
    setMounted(true);
    // Strict hardware check specifically for the heavy 3D Robot
    ...
    // High-end check ONLY applies to the Robot. 
    // iPhone/iPad are allowed. Otherwise, must have 8+ cores AND 8GB+ RAM.
